...
window.trulyRandom = function() {
  ...
  for (let i=0; i<50; i++) {
    ...
    for (let j=0; j<notesHeld; j++) {
      pitch.push(getRandomInt(20, 100)); // http://computermusicresource.com/midikeys.html
    }
    let duration = durations[getRandomInt(0,2)];
